...
export class RecipesController {
  ...
  @HttpCode(204)
  removeRatingByRecipeID(@Param('recipeId', ParseIntPipe) id: number) {
    this.recipesService.removeRatingByRecipeID(id);
  }
  ...
  @HttpCode(204)
  removeImageByRecipeID(@Param('recipeId', ParseIntPipe) id: number) {
    this.recipesService.removeImageByRecipeID(id);
  }
}
